...
seed-envs:
	...
	@grep -E '^(DEFAULT_LLM_PROVIDER|DEFAULT_LLM_MODEL|ANTHROPIC_API_KEY|OPENAI_API_KEY|GROQ_API_KEY|KEYCLOAK_ADMIN|KEYCLOAK_ADMIN_PASSWORD|ENCRYPTION_KEY|SMTP_HOST|SMTP_PORT|SMTP_USER|SMTP_PASS|SMTP_FROM|MINIO_ROOT_USER|MINIO_ROOT_PASSWORD|MEMPALACE_API_URL|MEMPALACE_API_TOKEN|OLLAMA_URL)=' $(ENV_FILE) 2>/dev/null \
